						...
						<?= form_open_multipart() ?>
							<div class="row">
								<div class="col s12">
									<div class="input-field">
										<input type="text" name="title" class="counter" data-length="255" maxlength="255" value="<?= set_value('title') ? set_value('title') : $berita->judul ?>" required>
							...
							<div class="row">
								<div class="col s12">
									<div class="py-2">
										<p>Konten</p>
										<textarea name="isi" class="browser-default ckeditor" required><?= set_value('isi') ? set_value('isi') : $berita->isi ?></textarea>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col s12">
									<div class="file-field input-field">
										<p>* Kosongkan jika tidak ingin mengubah gambar yang sudah ada</p>
										<div class="btn">
